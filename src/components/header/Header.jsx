...
//   // Количество товаров для демонстрации бейджей на иконках действий
...
//     `relative py-2 text-sm font-semibold tracking-wide transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-4 rounded-md flex items-center gap-1.5 ${
//       isActive
...
//     `flex items-center w-full px-4 py-3.5 rounded-xl text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
//       isActive
