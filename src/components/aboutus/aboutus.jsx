...
export default function AboutUs() {
  ...
  const contacts = [
    { id: 1, icon: MapPin, text: 'г. Душанбе, пр. Рудаки 45 / г. Худжанд, ул. Ленина 12' },
    { id: 2, icon: Phone, text: '+992 (99) 111-22-33, +992 (44) 600-00-00' },
    { id: 3, icon: Mail, text: 'support@accesora.tj, info@accesora.tj' },
  ];
